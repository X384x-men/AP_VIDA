...
@Component({
  selector: 'app-solicitudes-fonacot',
  templateUrl: './solicitudes-fonacot.component.html',
  styleUrls: ['./solicitudes-fonacot.component.css']
})
export class SolicitudesFonacotComponent {
