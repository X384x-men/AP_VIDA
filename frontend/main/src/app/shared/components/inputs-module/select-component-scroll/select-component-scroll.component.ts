...
@Component({
  selector: 'app-select-component-scroll',
  templateUrl: './select-component-scroll.component.html',
  styleUrls: ['./select-component-scroll.component.css']
})
export class SelectComponentScrollComponent implements OnInit, OnChanges {
